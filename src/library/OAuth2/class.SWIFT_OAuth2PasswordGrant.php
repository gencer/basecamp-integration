...
class SWIFT_OAuth2PasswordGrant extends SWIFT_OAuth2GrantTypeBase
{
	...
	{
		throw new SWIFT_OAuth2Exception('Password grant type does not support Authorization Request');
	}
	...
	protected function CheckTokenRequestParams(array $_params)
	{
		if (!isset($_params['username']) || !isset($_params['password'])) {
			throw new SWIFT_OAuth2Exception('username and password are required to token request query');
		}

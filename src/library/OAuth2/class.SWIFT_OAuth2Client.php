...
class SWIFT_OAuth2Client extends SWIFT_Library
{
	 ...
	 */
	public function GetCodeGrantAccessToken(
		$_code, array $_extraParams = array(), $_clientAuthType = SWIFT_OAuth2GrantType_Interface::AUTH_TYPE_AUTHORIZATION_FORM, array $_headers = array(), $_method = 'POST')
	{
	 ...
	 * @return mixed response retuned by server
	 */
	public function GetPasswordGrantAccessToken(
		$_userName, $_password, array $_extraParams = array(), $_clientAuthType = SWIFT_OAuth2GrantType_Interface::AUTH_TYPE_AUTHORIZATION_FORM, array $_headers = array(),
		$_method = 'POST')
	{
	 ...
	 * @return mixed response retuned by server
	 */
	public function GetClientGrantAccessToken(
		array $_extraParams = array(), $_clientAuthType = SWIFT_OAuth2GrantType_Interface::AUTH_TYPE_AUTHORIZATION_FORM, array $_headers = array(), $_method = 'POST')
	{
	...
	public function GetRefreshToken(
		$_refreshToken, array $_extraParams = array(), $_clientAuthType = SWIFT_OAuth2GrantType_Interface::AUTH_TYPE_AUTHORIZATION_FORM, array $_headers = array(),
		$_method = 'POST')
	{
